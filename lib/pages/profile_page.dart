...
import 'package:firebase_signin/pages/login_page.dart';
import 'package:firebase_signin/pages/splash_screen.dart';
import 'package:firebase_signin/pages/widgets/header_widget.dart';
        ...
        flexibleSpace:Container(
          decoration: BoxDecoration(
              gradient: LinearGradient(
                  ...
                  end: Alignment.bottomRight, colors: [Colors.blue],
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text('Mr. Klaus Mikaelson', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
                  Text('Business Man', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                  SizedBox(height: 10,),
                  Container(
                                    ...
                                    ...ListTile.divideTiles(
                                      ...
                                      tiles: [
                                        ...
                                        ListTile(
                                          ...
                                          title: Text("Email"),
                                          subtitle: Text("Klaus_M@gmail.com"),
                                        ),
                                        ListTile(
